...
if sys.platform.startswith('win32'):
    ...
    from ogl.win32_gdi import PFD_DRAW_TO_WINDOW, PFD_SUPPORT_OPENGL, PFD_DOUBLEBUFFER, PFD_TYPE_RGBA, \
                            PixelFormatDescriptor, get_dc, choose_pixel_format, set_pixel_format, \
                            get_pixel_format, swap_buffers


    from ogl.ogl_hdr import wglCreateContext, wglMakeCurrent

elif sys.platform.startswith('linux'):

    from ogl.x11_gdi import X11_None, x_open_display

    from ogl.ogl_hdr import PGLint, GLX_RGBA, GLX_DEPTH_SIZE, GLX_DOUBLEBUFFER, GL_TRUE, \
...
class TkOglWin(Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.parent.title(kwargs.get('Pod Parrot', 'Opengl Test'))
